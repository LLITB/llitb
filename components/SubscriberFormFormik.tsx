...
function SubscriberFormFormik({ }: Props) {
                ...
                onSubmit={async (values, { resetForm }) => {
                    ...
                    try {
                        ...
                        if (datas.status >= 400) {
                            ...
                            setMessage("Error joining the newsletter. You can directly contact me at Live Life In The Black.");
                            setTimeout(() => {
                                setMessage("");
            ...
            >
                <Form className="w-full">
                    <div className="w-full bg-transparent border flex-1 border-black rounded-full flex gap-2 px-3">
                        <Field type="text" name="firstName" className="w-1/2 grow rounded-md bg-transparent px-5 py-3 outline-none" placeholder="Enter your first name" autoComplete="off" />
                        <Field type="text" name="lastName" className="w-1/2 grow rounded-md bg-transparent px-5 py-3 outline-none" placeholder="Enter your last name" autoComplete="off" />
...
export default SubscriberFormFormik;
